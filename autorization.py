...
class Ui_AuthWindow(object):
    def setupUi(self, AuthWindow):
        ...
        self.auth_button.setGeometry(QtCore.QRect(10, 280, 181, 31))
        font = QtGui.QFont()
        ...
        self.auth_button.setStyleSheet("background-color: rgb(83, 83, 83);\n"
"color: rgb(0, 0, 0);\n"
"border-radius: 10px;\n"
...
"background-color: rgb(83, 83, 83);")
        ...
        self.error_label.setGeometry(QtCore.QRect(20, 240, 191, 16))
        font = QtGui.QFont()
        font.setFamily("Gotham Black")
        font.setPointSize(12)
        font.setBold(True)
