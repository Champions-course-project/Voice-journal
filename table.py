...
class Ui_table_window(object):
    def setupUi(self, table_window):
        ...
        self.group_table.setRowCount(26)
        item = QtWidgets.QTableWidgetItem()
        self.group_table.setVerticalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.group_table.setVerticalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.group_table.setVerticalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.group_table.setVerticalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        self.group_table.setVerticalHeaderItem(4, item)
        item = QtWidgets.QTableWidgetItem()
        self.group_table.setVerticalHeaderItem(5, item)
        item = QtWidgets.QTableWidgetItem()
        self.group_table.setVerticalHeaderItem(6, item)
        item = QtWidgets.QTableWidgetItem()
        self.group_table.setVerticalHeaderItem(7, item)
        item = QtWidgets.QTableWidgetItem()
        self.group_table.setVerticalHeaderItem(8, item)
        item = QtWidgets.QTableWidgetItem()
        self.group_table.setVerticalHeaderItem(9, item)
        item = QtWidgets.QTableWidgetItem()
        self.group_table.setVerticalHeaderItem(10, item)
        item = QtWidgets.QTableWidgetItem()
        self.group_table.setVerticalHeaderItem(11, item)
        item = QtWidgets.QTableWidgetItem()
        self.group_table.setVerticalHeaderItem(12, item)
        item = QtWidgets.QTableWidgetItem()
        self.group_table.setVerticalHeaderItem(13, item)
        item = QtWidgets.QTableWidgetItem()
        self.group_table.setVerticalHeaderItem(14, item)
        item = QtWidgets.QTableWidgetItem()
        self.group_table.setVerticalHeaderItem(15, item)
        item = QtWidgets.QTableWidgetItem()
        self.group_table.setVerticalHeaderItem(16, item)
        item = QtWidgets.QTableWidgetItem()
        self.group_table.setVerticalHeaderItem(17, item)
        item = QtWidgets.QTableWidgetItem()
        self.group_table.setVerticalHeaderItem(18, item)
        item = QtWidgets.QTableWidgetItem()
        self.group_table.setVerticalHeaderItem(19, item)
        item = QtWidgets.QTableWidgetItem()
        self.group_table.setVerticalHeaderItem(20, item)
        item = QtWidgets.QTableWidgetItem()
        self.group_table.setVerticalHeaderItem(21, item)
        item = QtWidgets.QTableWidgetItem()
        self.group_table.setVerticalHeaderItem(22, item)
        item = QtWidgets.QTableWidgetItem()
        self.group_table.setVerticalHeaderItem(23, item)
        item = QtWidgets.QTableWidgetItem()
        self.group_table.setVerticalHeaderItem(24, item)
        item = QtWidgets.QTableWidgetItem()
        self.group_table.setVerticalHeaderItem(25, item)
        item = QtWidgets.QTableWidgetItem()
        ...
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.group_table.setItem(0, 0, item)
        item = QtWidgets.QTableWidgetItem()
        self.group_table.setItem(0, 1, item)
    ...
    def retranslateUi(self, table_window):
        ...
        __sortingEnabled = self.faculty_list.isSortingEnabled()
        self.faculty_list.setSortingEnabled(False)
        item = self.faculty_list.item(0)
        item.setText(_translate("table_window", "ИСИ"))
        item = self.faculty_list.item(1)
        item.setText(_translate("table_window", "ИАиД"))
        item = self.faculty_list.item(2)
        item.setText(_translate("table_window", "ИСПТиК"))
        item = self.faculty_list.item(3)
        item.setText(_translate("table_window", "ИЭУ"))
        item = self.faculty_list.item(4)
        item.setText(_translate("table_window", "ОМО"))
        item = self.faculty_list.item(5)
        item.setText(_translate("table_window", "ПКВК"))
        item = self.faculty_list.item(6)
        item.setText(_translate("table_window", "ТЭФ"))
        item = self.faculty_list.item(7)
        item.setText(_translate("table_window", "ФАИТ"))
        item = self.faculty_list.item(8)
        item.setText(_translate("table_window", "ФВиИ"))
        item = self.faculty_list.item(9)
        item.setText(_translate("table_window", "ФЕНМиИТ"))
        item = self.faculty_list.item(10)
        item.setText(_translate("table_window", "ФИРиД"))
        item = self.faculty_list.item(11)
        item.setText(_translate("table_window", "ФКФН"))
        item = self.faculty_list.item(12)
        item.setText(_translate("table_window", "ФНДиДО"))
        item = self.faculty_list.item(13)
        item.setText(_translate("table_window", "ФПЭ"))
        item = self.faculty_list.item(14)
        item.setText(_translate("table_window", "ФПСГТ"))
        item = self.faculty_list.item(15)
        item.setText(_translate("table_window", "ФФК"))
        item = self.faculty_list.item(16)
        item.setText(_translate("table_window", "ФФПиМК"))
        item = self.faculty_list.item(17)
        item.setText(_translate("table_window", "ЮИ"))
        self.faculty_list.setSortingEnabled(__sortingEnabled)
        ...
        item = self.group_table.verticalHeaderItem(0)
        item.setText(_translate("table_window", "Абидуев Баясхалан"))
        item = self.group_table.verticalHeaderItem(1)
        item.setText(_translate("table_window", "Акованцев Андрей"))
        item = self.group_table.verticalHeaderItem(2)
        item.setText(_translate("table_window", "Батурин Владислав"))
        item = self.group_table.verticalHeaderItem(3)
        item.setText(_translate("table_window", "Безруков Михаил"))
        item = self.group_table.verticalHeaderItem(4)
        item.setText(_translate("table_window", "Бородин Максим"))
        item = self.group_table.verticalHeaderItem(5)
        item.setText(_translate("table_window", "Гамурарь Даниил"))
        item = self.group_table.verticalHeaderItem(6)
        item.setText(_translate("table_window", "Гараньков Алексей"))
        item = self.group_table.verticalHeaderItem(7)
        item.setText(_translate("table_window", "Дам Александр"))
        item = self.group_table.verticalHeaderItem(8)
        item.setText(_translate("table_window", "Драгина Елизавета"))
        item = self.group_table.verticalHeaderItem(9)
        item.setText(_translate("table_window", "Иштокин Роман"))
        item = self.group_table.verticalHeaderItem(10)
        item.setText(_translate("table_window", "Кармадонов Максим"))
        item = self.group_table.verticalHeaderItem(11)
        item.setText(_translate("table_window", "Костин Александр"))
        item = self.group_table.verticalHeaderItem(12)
        item.setText(_translate("table_window", "Мытник Ирина"))
        item = self.group_table.verticalHeaderItem(13)
        item.setText(_translate("table_window", "Нижникова Виктория"))
        item = self.group_table.verticalHeaderItem(14)
        item.setText(_translate("table_window", "Новоженин Михаил"))
        item = self.group_table.verticalHeaderItem(15)
        item.setText(_translate("table_window", "Палёха Кирилл"))
        item = self.group_table.verticalHeaderItem(16)
        item.setText(_translate("table_window", "Пискун Кирилл"))
        item = self.group_table.verticalHeaderItem(17)
        item.setText(_translate("table_window", "Пожидаев Дмитрий"))
        item = self.group_table.verticalHeaderItem(18)
        item.setText(_translate("table_window", "Рязанов Владислав"))
        item = self.group_table.verticalHeaderItem(19)
        item.setText(_translate("table_window", "Савиных Данила"))
        item = self.group_table.verticalHeaderItem(20)
        item.setText(_translate("table_window", "Син Эрнест"))
        item = self.group_table.verticalHeaderItem(21)
        item.setText(_translate("table_window", "Стрэжеску Дарья"))
        item = self.group_table.verticalHeaderItem(22)
        item.setText(_translate("table_window", "Сухих Дмитрий"))
        item = self.group_table.verticalHeaderItem(23)
        item.setText(_translate("table_window", "Удодов Руслан"))
        item = self.group_table.verticalHeaderItem(24)
        item.setText(_translate("table_window", "Хмелёв Владислав"))
        item = self.group_table.verticalHeaderItem(25)
        item.setText(_translate("table_window", "Швец Роман"))
        ...
        __sortingEnabled = self.group_table.isSortingEnabled()
        self.group_table.setSortingEnabled(False)
        self.group_table.setSortingEnabled(__sortingEnabled)
