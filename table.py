...
class Ui_table_window(object):
    def setupUi(self, table_window):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../.designer/Voice-journal/ProgrammIcon.ico"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"gridline-color: rgb(17, 17, 17);")
        ...
        self.group_table.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.SizeAdjustPolicy.AdjustToContentsOnFirstShow)
